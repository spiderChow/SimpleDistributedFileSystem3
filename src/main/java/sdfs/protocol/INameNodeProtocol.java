...
public interface INameNodeProtocol extends Remote {
     ...
     */
    SDFSFileChannelData create(String fileUri) throws SDFSFileAlreadyExistException, RemoteException, FileNotFoundException;
     ...
     */
    void mkdir(String fileUri) throws SDFSFileAlreadyExistException,RemoteException;
    ...
    LocatedBlock addBlock(UUID accessToken) throws RemoteException;
