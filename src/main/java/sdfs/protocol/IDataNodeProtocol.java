...
public interface IDataNodeProtocol extends Remote {
    ...
    void copyOnWrite(UUID accessToken, int blockNumber, int blockNumber1) throws IllegalAccessTokenException, IOException;

    int getBlockSize()throws RemoteException, IllegalAccessTokenException, IllegalArgumentException;
}